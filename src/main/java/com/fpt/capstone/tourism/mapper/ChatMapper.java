...
import com.fpt.capstone.tourism.dto.common.chat.ChatGroupDTO;
...
public interface ChatMapper {
    ...
    ChatGroup toChatGroupEntity(ChatGroupDTO chatGroupDTO);

    @Mapping(target = "userId", source = "user.id")
    ChatGroupDTO toChatGroupDTO(ChatGroup chatGroup);
